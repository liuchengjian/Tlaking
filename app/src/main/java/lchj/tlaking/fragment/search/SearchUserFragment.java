...
import com.dqjq.common.widget.convention.EmptyView;
import com.dqjq.factory.data.bean.UserCard;
import com.dqjq.factory.presenter.contact.FollowContract;
import com.dqjq.factory.presenter.contact.FollowPresenter;
import com.dqjq.factory.presenter.search.SearchContract;
import com.dqjq.factory.presenter.search.SearchUserPresenter;
...
public class SearchUserFragment extends PresenterFragment<SearchContract.Presenter>
    ...
    class ViewHolder extends BaseRecyclerAdapter.ViewHolder<UserCard>
        ...
        void onFollowClick() {
            // 发起关注
            if(mData.getId().equals(Account.getUserId())){
                MyApp.showToast("不能关注自己");
            }else{
